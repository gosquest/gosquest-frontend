...
const AboutPage = () => {
   return (
      <>
         ...
         >
            <motion.div
               className="py-4 flex flex-col items-center justify-center gap-4"
            ...
            >
               ...
               <motion.p
                  className="text-center md:w-5/6 text-gray-700"
                  variants={fadeInUp}
               >
                  Our goal is to connect people to the truth and love of the
                  Gospel, bringing hope and purpose to lives around the globe.
                  We share Gospel teachings, inspire faith, and foster
                  community, transforming lives one soul at a time.
               </motion.p>
               ...
               <div className="flex mt-8 md:mt-12 flex-wrap gap-8 md:gap-40 justify-center">
                  ...
                  >
                     ...
                     <small className="text-gray-600">
                        We strive to empower believers with spiritual resources,
                        guide them on their faith journey, and foster an
                        environment of love and understanding, paving the way
                        for a brighter, faith-filled tomorrow.
                     </small>
                  </motion.div>
                  <motion.div
                     className="flex flex-col gap-4 max-w-[400px]"
                  ...
                  >
                     ...
                     <small className="text-gray-600">
                        Through our community and various outreach programs, we
                        spread joy and bring the message of the Gospel to
                        uplift, comfort, and inspire.
                     </small>
                  </motion.div>
                  <motion.div
                     className="flex flex-col gap-4 max-w-[400px]"
                  ...
                  >
                     ...
                     <small className="text-gray-600">
                        ...
                        fostering a welcoming space for all.
                     </small>
                  </motion.div>
               </div>
            </motion.div>
            ...
            >
               ...
               >
                  <div className="md:w-1/2 text-center md:text-left">
                     ...
                     <p className="text-gray-700">
                        By joining us, you will find a renewed sense of purpose
                        and joy, connected with a community that encourages
               ...
               >
                  ...
                  <div className="md:w-1/2 text-center md:text-left">
                     ...
                     <p className="text-gray-700">
                        We uphold values rooted in faith, compassion, and unity,
                        offering a sense of belonging and shared purpose in our
                        journey together.
                     </p>
                  </div>
               </motion.div>
               ...
               >
                  <div className="md:w-1/2 text-center md:text-left">
                     ...
                     <p className="text-gray-700">
                        We provide opportunities for charitable giving, where
                        your acts of kindness contribute to the well-being of
                        others.
                     </p>
                  </div>
                  <motion.div
