   ...
   const handleDrop = async (acceptedFiles: File[]) => {
      ...
      try {
         ...
         if (response && response.filename) {
            const fileUrl = `/websites/logo/${response.filename}`;
         ...
         render={({ field }) => (
            <FormItem>
               ...
               <FormControl>
                  <div
                     {...getRootProps()}
                     className={`p-6 rounded border-dashed border-2 text-main flex flex-col items-center gap-2 ${
                     ...
                     {logo ? (
                        ...
                        <>
                           ...
                           {isDragActive ? (
                              ...
                              <p>
                                 Drag & drop logo here, or <span>Browse</span>
                              </p>
                           )}
                        </>
                     )}
