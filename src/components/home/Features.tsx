...
export function Features() {
   return (
      ...
      >
         {/* Feature 1 */}
         <motion.div
            className="flex flex-col gap-x-6 sm:flex-row-reverse gap-6 md:gap-0"
            variants={fadeInUp}
         >
            <motion.div
            ...
            <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
               ...
               <p className="py-[24px] text-[#36485C] lg:text-[18px]">
                  Access a curated list of gospel websites to stay connected
                  with spiritual content that enriches your faith journey.
               </p>
               <ul className="flex flex-col gap-y-3 lg:text-[18px]">
                  {[
                     "Daily devotionals and prayer guides",
                     "Bible study resources for all ages",
                     "Inspiring articles and gospel blogs",
                  ].map((text, index) => (
                     <li
                        key={index}
         ...
         {/* Feature 2 */}
         <motion.div
            className="flex flex-col gap-x-6 sm:flex-row gap-6 md:gap-0"
            variants={fadeInUp}
         >
            <motion.div
               className="w-full sm:w-1/2 lg:w-[50%] overflow-hidden"
            ...
            <div className="sm:w-1/2 lg:py-[56px] lg:pl-[56px]">
               <h3 className="font-medium  lg:text-[18px]">
               ...
               <p className="py-[24px] text-[#36485C] lg:text-[18px]">
                  Explore a variety of gospel channels on YouTube with
                  GosQuest’s guidance, featuring sermons, music, and teachings.
               </p>
               <ul className="flex flex-col gap-y-3 lg:text-[18px]">
                  {[
                     "Popular worship channels and live-streamed services",
                     "Access to gospel music playlists and artists",
                     "Bible teaching series and discussions",
                  ].map((text, index) => (
                     <li
                        key={index}
                        className="flex items-center gap-x-2 text-[#36485C]"
         ...
         >
            ...
            <div className="sm:w-1/2 lg:py-[56px] lg:pr-[56px]">
               ...
               <p className="py-[24px] text-[#36485C] lg:text-[18px]">
                  Discover games that reinforce Christian values, designed to
                  entertain while deepening your understanding of faith.
               </p>
