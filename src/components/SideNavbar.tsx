...
export default function SideNavbar() {
   ...
   return (
      <div
         className={`fixed min-h-screen border-r max-h-screen px-3 pb-10 pt-6 bg-main flex flex-col justify-between z-40 text-white transition-all duration-300 ease-in-out
