  ...
  return (
    <div className="bg-main  mb-6 p-4 text-white md:hidden">
      ...
      <div className="bg-input rounded p-4 flex justify-between items-center">
        ...
        <Link href={'/dashboard/rated-projects'} className="px-4 py-2 rounded bg-transparent text-main whitespace-nowrap hover:bg-main hover:text-white">Rated projects</Link>
      </div>
    </div>
  );
};
